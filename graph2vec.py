...
# dict_NodeName = {"NULL": 0, "VAR0": 1, "VAR1": 2, "VAR2": 3, "VAR3": 4, "VAR4": 5, "VAR5": 6, "S": 7,
#                  "W0": 8, "W1": 9, "W2": 10, "W3": 11, "W4":  12,"W5": 8, "W6": 9, "W7": 10, "W8": 11, "W4": 12,
#                  "C0": 13, "C1": 14, "C2": 15, "C3": 16, "C4": 17,"C5":18,"F":19}
dict_NodeName = {"NULL": 0, "VAR0": 1, "VAR1": 2, "VAR2": 3, "VAR3": 4, "VAR4": 5, "VAR5": 6, "S": 7, "W0": 8,
                 "W1": 9, "W2": 10, "W3": 11, "W4": 12, "C0": 13, "C1": 14, "C2": 15, "C3": 16, "C4": 17,"C5":18,"F":19}
...
v2o = vec2onehot.vec2onehot()  # create the one-bot dicts
...
def extract_node_features(nodeFile):
    ...
    f = open(nodeFile)
    lines = f.readlines()#每行是一个string
    f.close()

    for line in lines:
        node = list(map(str, line.split()))# node_feature[i] from autoextractgraph
        print(node)
        verExist = False
...
def elimination_node(node_attribute_list):
    main_point = ['S', 'W0', 'W1', 'W2', 'W3', 'W4', 'C0', 'C1', 'C2', 'C3', 'C4','C5', 'F']
